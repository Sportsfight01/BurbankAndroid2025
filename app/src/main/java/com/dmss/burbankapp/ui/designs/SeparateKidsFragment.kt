...
import com.dmss.burbankapp.databinding.FragmentSeparateKidsBinding
...
class SeparateKidsFragment : Fragment(), BreadCrumbAdapter.BreadcrumbItemClickListener, MainActivity.OnBackPressedListener {
    private var apiCallHappen: Boolean = false
    private var FEATURE = "Separate Kids Living Area"

    private lateinit var binding: FragmentSeparateKidsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSeparateKidsBinding.inflate(inflater, container, false)
                        ...
                        if (newHomeNextFeatureResponseModel != null && newHomeNextFeatureResponseModel.status) {
                            ...
                            if (newHomeNextFeatureResponseModel.status) {
                                ...
                                if (newHomeNextFeatureResponseModel.newHomesNextFeatures?.nextFeature != null) {
                                    ...
                                    nextFragment = MyCollectionPlacesFragment()
                                }

                                if (this::bottomLayoutBinding.isInitialized) {
                                    isNextClickable = AppUtils.disableAndEnableView(
                                        newHomeNextFeatureResponseModel.newHomesNextFeatures?.HouseCount?:0,
    ...
    private fun initViews() {
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | Separate Kids Living Area"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("Separate Kids Living Area", FEATURE)
