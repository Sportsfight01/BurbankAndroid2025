...
import com.dmss.burbankapp.databinding.FragmentLivingMealsCollectionBinding
...
class LivingMealsCollectionFragment : Fragment(), MainActivity.OnBackPressedListener,
    BreadCrumbAdapter.BreadcrumbItemClickListener {

    private var FEATURE = "Living/Meals Entire Rear"
    lateinit var binding: FragmentLivingMealsCollectionBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLivingMealsCollectionBinding.inflate(inflater, container, false)
    ...
    private fun initViews() {
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | Living/Meals Entire Rear"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("Living/Meals Entire Rear", FEATURE)
