...
import com.dmss.burbankapp.databinding.FragmentLotsOfStorageBinding
...
class LotsOfStorageFragment : Fragment(), MainActivity.OnBackPressedListener,
    BreadCrumbAdapter.BreadcrumbItemClickListener {
    private var apiCallHappen: Boolean = false
    private var FEATURE = "Storage (more than 1 per room)"
    ...
    lateinit var binding: FragmentLotsOfStorageBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLotsOfStorageBinding.inflate(inflater, container, false)
                        ...
                        if (newHomeNextFeatureResponseModel != null && newHomeNextFeatureResponseModel.status) {
                            ...
                            if (newHomeNextFeatureResponseModel.status) {
                                ...
                                if (this::bottomLayoutBinding.isInitialized) {
                                    isNextClickable = newHomeNextFeatureResponseModel.newHomesNextFeatures?.let { it1 ->
    ...
    private fun initViews() {
        ...
        newHomesNextFeaturesModel =
            arguments?.getParcelable(AppConstants.NEWHOMENEXTQUESTIONMODEL)!!
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | Storage (more than 1 per room)"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("Storage (more than 1 per room)", FEATURE)
