...
import com.dmss.burbankapp.databinding.FragmentStarightCorridorBinding
...
class StarightCorridorFragment : Fragment(), BreadCrumbAdapter.BreadcrumbItemClickListener, MainActivity.OnBackPressedListener {
    private var apiCallHappen: Boolean = false
    private var FEATURE = "Straight Corridor"
    lateinit var binding: FragmentStarightCorridorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentStarightCorridorBinding.inflate(inflater, container, false)
    ...
    private fun initViews() {
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | Straight Corridor"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("Straight Corridor", FEATURE)
    ...
    private fun setToolbarBreadCrumb(isFirstTime: Boolean) {

        var arrayList: java.util.ArrayList<BreadcrumbModel> = java.util.ArrayList()

        if (isFirstTime) {
            AppConstants.breadCrumbMyCollection.remove(FEATURE)
        }
        ...
        Timber.e("Toolbase list ----> " + arrayList.size)
