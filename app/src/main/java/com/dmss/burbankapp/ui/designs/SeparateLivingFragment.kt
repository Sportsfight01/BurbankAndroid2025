...
import com.dmss.burbankapp.databinding.FragmentSeparateLivingBinding
...
class SeparateLivingFragment: Fragment(), BreadCrumbAdapter.BreadcrumbItemClickListener, MainActivity.OnBackPressedListener {
    private var apiCallHappen: Boolean = false
    private var FEATURE = "Separate Living Area"

    private lateinit var binding: FragmentSeparateLivingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSeparateLivingBinding.inflate(inflater, container, false)
    ...
    private fun initViews() {
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | Separate Living Area"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("Separate Living Area", FEATURE)
