...
import com.dmss.burbankapp.databinding.FragmentEuropeanCupboardBinding
...
class EuropeanCupboardFragment : Fragment(), BreadCrumbAdapter.BreadcrumbItemClickListener, MainActivity.OnBackPressedListener {
    private var apiCallHappen = false
    private var FEATURE = "European Laundry"

    lateinit var binding: FragmentEuropeanCupboardBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEuropeanCupboardBinding.inflate(inflater, container, false)
    ...
    private fun initViews() {
        ...
        binding.imusthave.setOnClickListener {
            ...
            AppConstants.toolheaderHashMap[FEATURE] = " | European Laundry"
            AppConstants.breadCrumbMyCollection[FEATURE] =
                BreadCrumbHashMapModel("European Laundry", FEATURE)
