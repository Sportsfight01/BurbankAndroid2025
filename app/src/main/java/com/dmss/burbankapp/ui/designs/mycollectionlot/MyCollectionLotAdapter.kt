package com.dmss.burbankapp.ui.designs.mycollectionlot
...
class MyCollectionLotAdapter(
    var context: Context,
    var answerList: List<LotWidthItemModel>,
...
/*TODO Refer link */
//https://stackoverflow.com/questions/19699909/how-to-remove-zeros-after-decmal-from-string-remove-all-zero-after-dot/19699924
            meters.text = AppUtils.roundRemainingString(lot.lotWidth)
