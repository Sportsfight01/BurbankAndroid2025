...
/**
 * Created by Ashish.Kumar on 19-12-2016.
 */
...
public class TransparentProgressDialog extends Dialog {
    ...
    public TransparentProgressDialog(Context context, int resourceIdOfImage) {
        ...
        changeIconColor(context,resourceIdOfImage);
    ...
    private void changeIconColor(Context context ,int drawable){
        ...
        DrawableCompat.setTint(wrappedDrawable, context.getResources().getColor(R.color.colorAccent));
    }
}
