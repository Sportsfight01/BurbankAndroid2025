...
class ProgressWheel : View {
    ...
    private var mRimColor = Color.GREEN
    ...
    private var mCountText: String? = "100" // TODO: use a default from R.string...
    ...
    private fun setupBounds() {
        ...
        mCountTextWidth = mCountTextPaint.measureText(if (mCountText == null || TextUtils.isEmpty(mCountText)) " " else mCountText)
        ...
        if (mDefText != null){
            ...
            mDefTextWidth = mDefTextPaint.measureText(if (TextUtils.isEmpty(mDefText)) " " else mDefText)
        }
    }
